namespace PracticalParallelization
{
  ...
  internal class Program
  {
    ...
    private static readonly FileInfo InputFile = new FileInfo(@"plot.list");
      ...
      return File.ReadLines(InputFile.FullName)
          ...
          .Aggregate(
              () => {
                ...
                return new Dictionary<string, uint>(StringComparer.InvariantCultureIgnoreCase);
              }, //#1
              (localDic, line) => //#2
              {
